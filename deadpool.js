...
(function () {
  ...
  (canvascon = document.getElementById("deadpool")), init();

  function init() {
    const MODEL_PATH = "./assets/deadpoolfinal2.glb";
      ...
      function (gltf) {
        ...
        model.traverse((o) => {
          if (o.isMesh) {
            ...
            // o.material = bharath_mtl;
            // o.shoe = bharathShoes_mtl;
            // o.m = bharathS_mtl;
          }
